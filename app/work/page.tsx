...
export default function WorkPage() {
  return (
    <article className="mx-auto max-w-3xl px-5 py-16 space-y-8">
      <p className="stamp">Selected work</p>
      <h1 className="display text-5xl sm:text-6xl">Pipeline CRM</h1>
      ...
      <section className="space-y-4 leading-relaxed">
        <h2 className="display text-3xl">What it replaced</h2>
      ...
      <p>
        <Link href="/contact?service=custom-ops-app" className="btn btn-fill">
